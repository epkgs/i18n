...
func Definef[Args any, E error](i18n *i18n.I18n, format string, wrapper Wrapper[E]) *DefinitionF[E, Args] {
...
//   - wrapper是一个错误包装函数，用于将原始错误包装成新的错误类型。
func Define[E error](i18n *i18n.I18n, msg string, wrapper Wrapper[E]) *Definition[E] {
	// 调用 Definef 函数创建一个通用的错误定义。
	def := Definef[None](i18n, msg, wrapper)
...
func newDefinition[E error, Args any](t *i18n.Item, wrapper Wrapper[E]) *DefinitionF[E, Args] {
